...
| E07 | [Nested bands vs flat heterogeneity](E07_nested_bands.md) | Does banding at a fixed ratio with slow-phase gating beat unstructured frequencies? | designed, not started | conditions A-D at matched parameter count; C-vs-B isolates structure, D-vs-C isolates cross-frequency modulation |
| E08 | [Spiking readout under precision loss](E08_spiking_readout.md) | Does a spike-timing code read the surviving information more robustly? | designed, not started | E06 is the measured baseline it has to beat, and it inverted the original hypothesis |

Visual summary of the whole project: [diagrams.md](diagrams.md).

Background reading, annotated: [reading.md](reading.md).
